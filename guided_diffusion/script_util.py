...
def diffusion_defaults():
    """
    Mặc định cho việc đào tạo hình ảnh và phân loại.
    """
    return dict(
        learn_sigma=False,
...
def model_and_diffusion_defaults():
    ...
    res = dict(
        ...
        num_res_blocks=2,
        num_heads=4,
        in_ch = 3, # Changed from 5 to 3 (e.g., 1 image channel + 2 mask channels)
        ...
        dpm_solver = False,
        version = 'medsegdiff-v2', # Set medsegdiff-v2 as default
    )
...
def create_model(
    ...
    elif version == 'medsegdiff-v2':
        return UNetModel_MedSegDiffV2(
            image_size=image_size,
            in_channels=in_ch,
            model_channels=num_channels,
            out_channels=2,  # (3 if not learn_sigma else 6),
